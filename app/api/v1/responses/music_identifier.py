...
class MusicResponse(BaseModel):
    ...
    total_platform: Optional[int] = Field(
        ..., description="Total platforms of the music"
    )
    total_time: Optional[int] = Field(..., description="Total time of the music")
    platform_details: Optional[list[PlatformDetails]] = Field(
        ..., description="Platform details of the music"
    )
